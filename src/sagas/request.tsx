...
function* getQuoteRequest(parameter: Object) {
    yield put({ type: 'SENDMESSAGE', payload: wsRequest.createQuoteRequest(parameter.payload, '2')});
}

function* getBPIQuoteRequest(parameter: Object) {
    yield put({ type: 'SENDMESSAGE', payload: wsRequest.createQuoteRequest(parameter.payload, '2')});
}

function* getTradesRequest(parameter: Object) {
...
function* getOrdersRequest(parameter: Object) {
...
function* startSendPublicRequest(parameter: Object) {
...
function* startSendPrivateRequest(parameter: Object) {
...
function* cancelOrderRequest(parameter: Object) {
...
function* getRetrieveTransactionsRequest(parameter: Object) {
