...
export class IOrderbook extends Immutable.Record({
    ...
    readonly AskData: Immutable.List<>;
    readonly BidData: Immutable.List<>;
    readonly AskDataWithDepth: Immutable.List<>;
    readonly BidDataWithDepth: Immutable.List<>;
...
export default function orderbook(state: IOrderbook = initialState, action: IOrderbookAction): any {
    switch (action.type) {
        ...
        case 'get market depth chart':
          const bidDepth1 = Immutable.List([]);
          const askDepth1 = Immutable.List([]);
